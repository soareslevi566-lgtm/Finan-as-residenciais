...
public record CriarTransacaoDto([Required, MaxLength(250)] string Descricao, [Range(0.01, double.MaxValue)] decimal Valor, TipoTransacao Tipo, [Range(1, int.MaxValue)] int PessoaId);
